...
После успешной GitHub Actions сборки скачай артефакт `NightVault-Windows` и создай GitHub Release с тегом `v0.9.6`. В релиз обязательно прикрепить:
