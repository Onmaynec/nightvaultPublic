...
ipcMain.handle('app-minimize',()=>{ try{ if(mainWindow?.isFullScreen()) mainWindow.setFullScreen(false); setTimeout(()=>mainWindow?.minimize(), 90); }catch{} });
...
ipcMain.handle('app-version', ()=> app.getVersion() || '0.9.9');
